...
# Changed device properties to Study Effects 

device_width = 2.0e-5      
gate_width = 1.0e-5        
diffusion_width = 0.5e-5   

air_thickness = 1e-7
oxide_thickness = 2e-7     
gate_thickness = 1e-6      
device_thickness = 2e-6    
diffusion_thickness = 5e-7 

x_diffusion_decay = 1e-8
y_diffusion_decay = 1e-8
...
y_channel_spacing = 5e-8
y_diffusion_spacing = 1e-7
y_gate_top_spacing = 1e-7
y_gate_mid_spacing = gate_thickness * 0.25
y_gate_bot_spacing = 5e-8
y_oxide_mid_spacing = oxide_thickness * 0.25
x_channel_spacing = 5e-8
x_diffusion_spacing = 1e-7
max_y_spacing = 1e-5
max_x_spacing = 1e-5
y_bulk_mid_spacing = device_thickness * 0.25
y_bulk_bottom_spacing = 1e-7
